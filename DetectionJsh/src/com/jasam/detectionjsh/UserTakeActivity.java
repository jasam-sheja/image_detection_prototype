...
public class UserTakeActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * 
		 * setContentView(R.id.activity_surface_view); /*mOpenCvCameraView =
		 * (CameraBridgeViewBase) new JavaCameraView(this, -1);
		 * setContentView(mOpenCvCameraView);
		 * mOpenCvCameraView.setCvCameraViewListener(this);/ mOpenCvCameraView =
		 * (CameraBridgeViewBase) findViewById(R.id.activity_surface_view);
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		if (viewmatches) {
			...
			// Features2d.drawMatches(mGray, keypoints, targetmGray,
			// targetKeypoint, matches, img_keypoint);
			...
			if (dmatches.size() > 3 && dmatches.get(3).distance < 70) {
				good_dmatches = dmatches.subList(0,
						Math.max(4, dmatches.size() / 10));
			}
			...
			Features2d.drawMatches(mGray, keypoints, targetmGray,
					targetKeypoint, goodDmatches, img_keypoint);
