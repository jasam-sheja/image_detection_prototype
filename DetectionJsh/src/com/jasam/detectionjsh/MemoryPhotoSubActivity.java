...
public class MemoryPhotoSubActivity extends Activity implements CvCameraViewListener2{
...
private static final String  TAG = "Sample::Detect::Activity";
	...
	private void getparameters(){
	    ...
	    targetmGray = new Mat();
	    Imgproc.cvtColor(Highgui.imread(photopath), targetmGray, Imgproc.COLOR_RGB2GRAY); 
...
//    	Imgproc.goodFeaturesToTrack(mGray, matofpoint, maxCorners, qualitylevel,mindistance );
//    	List<KeyPoint> temp = new LinkedList<KeyPoint>();
//    	Converters.Mat_to_vector_KeyPoint(Converters.vector_Point_to_Mat(matofpoint.toList()), temp); 
//    	keypoints = new MatOfKeyPoint();
...
//
//	    MatOfPoint matofpoint = new MatOfPoint();
//    	Imgproc.goodFeaturesToTrack(targetmGray, matofpoint, maxCorners, qualitylevel,mindistance );
//    	List<KeyPoint> temp = new LinkedList<KeyPoint>();
//    	Converters.Mat_to_vector_KeyPoint(Converters.vector_Point_to_Mat(matofpoint.toList()), temp); 
//    	targetKeypoint = new MatOfKeyPoint();
